export const STUDENT_FORM_GROUPS = [
  {
    category: "Lisans",
    items: [
      {
      ...
      {
        label:
          "DD-050 Matematik Mühendisliği Bitirme Çalışması ve Tasarım Uygulaması Hazırlama Esasları",
        kind: "doc",
  ...
  },
  {
    ...
    items: [
      ...
      {
        label:
          "FR-1503 FBE Seminer Dersi Kayıt ve Değerlendirme Formu",
        kind: "docx",
...
export const STAFF_FORM_GROUPS = [
  {
    ...
    items: [
      {
        label:
          "FR-0714 Fakülte-Yüksekokul Akademik-İdari Personel Genel Dilekçe Formu",
        kind: "docx",
      ...
      {
        label:
          "FR-0269 Akademik Birimlerde Çalışan İdari Personel İzin Onay Formu",
        kind: "doc",
