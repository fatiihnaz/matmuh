    ...
    <main className="w-full flex-1 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-8">
          {heroStats.map((stat) => (
            <div key={stat.id} className="flex flex-col rounded-xl p-6 bg-background border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 grid-flow-row lg:grid-flow-col gap-6">
          <div key="misyon" className="rounded-xl p-6 bg-[#FFFFFF] border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <div key="calisma" className="rounded-xl bg-[#FFFFFF] border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
          ...
          <div key="arastirma" className="rounded-xl p-6 bg-[#FFFFFF] border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <div key="kilometretasi" className="rounded-xl p-6 bg-[#FFFFFF] border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            <div className="flex justify-between items-start mb-6">
              <div className="space-y-1">
                <div className="flex items-center gap-2 mb-5">
                  <div className="w-1 h-5 rounded-full bg-secondary-500"/>
          ...
          <div key="akreditasyon" className="rounded-xl p-6 bg-[#FFFFFF] border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            <div className="flex justify-between items-start mb-6">
              <div className="space-y-1">
                <div className="flex items-center gap-2 mb-5">
                  <div className="w-1 h-5 rounded-full bg-secondary-500"/>
          ...
          <div key="statlar" className="rounded-xl p-6 bg-primary-500 border border-[rgba(0,0,0,0.06)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            <div className="flex items-center gap-2 mb-5">
              <div className="w-1 h-5 rounded-full bg-secondary-500"/>
