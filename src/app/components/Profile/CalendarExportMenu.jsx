      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full z-20 mt-2 w-[min(18rem,calc(100vw-3rem))] origin-top-right overflow-hidden rounded-xl bg-white shadow-xl shadow-primary-500/25 ring-1 ring-primary-500/10"
          >
