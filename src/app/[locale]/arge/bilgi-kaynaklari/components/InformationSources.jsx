                  ...
                  <motion.div key={item.id} variants={staggerItem}>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3.5 z-10 overflow-hidden">
                        <div className="shrink-0 w-10 h-10 rounded-xl bg-primary-500/4 border border-primary-500/5 flex items-center justify-center text-primary-500/50 group-hover:bg-secondary-500 group-hover:border-secondary-500 group-hover:text-white group-hover:scale-100 transition-all duration-300">
